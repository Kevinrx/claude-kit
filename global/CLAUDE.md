...
## Kit commands
`/kit:plan` · `/kit:roadmap` · `/kit:implement` · `/kit:verify` · `/kit:review` · `/kit:debug` · `/kit:address-review` · `/kit:second-opinion` · `/kit:handoff` · `/kit:learn` · `/kit:gate` · `/kit:terse` · `/kit:humanize`
